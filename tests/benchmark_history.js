        ...
        chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    { label: 'Recall', data: pagedData.map(r => r.csv_overall_recall != null ? r.csv_overall_recall : null), borderColor: '#10b981', backgroundColor: 'rgba(16, 185, 129, 0.1)', tension: 0.3, pointRadius: highSamplePointRadius, pointHoverRadius: 6, fill: false, borderWidth: 1, segment: { borderDash: ctx => (pagedData[ctx.p0DataIndex]?.csv_overall_recall == null || pagedData[ctx.p1DataIndex]?.csv_overall_recall == null) ? [5, 5] : [] } },
                    { label: 'F1 Score', data: pagedData.map(r => r.csv_overall_f1 != null ? r.csv_overall_f1 : null), borderColor: '#f59e0b', backgroundColor: 'transparent', tension: 0.3, pointRadius: highSamplePointRadius, pointHoverRadius: 6, fill: false, borderWidth: 1, segment: { borderDash: ctx => (pagedData[ctx.p0DataIndex]?.csv_overall_f1 == null || pagedData[ctx.p1DataIndex]?.csv_overall_f1 == null) ? [5, 5] : [] } },
                    { label: 'Precision', data: pagedData.map(r => r.csv_overall_precision != null ? r.csv_overall_precision : null), borderColor: '#6366f1', backgroundColor: 'rgba(99, 102, 241, 0.1)', tension: 0.3, pointRadius: highSamplePointRadius, pointHoverRadius: 6, fill: false, borderWidth: 1, segment: { borderDash: ctx => (pagedData[ctx.p0DataIndex]?.csv_overall_precision == null || pagedData[ctx.p1DataIndex]?.csv_overall_precision == null) ? [5, 5] : [] } },
        ...
        plugins: {
            ...
            tooltip: {
                ...
                external: function(context) {
                    ...
                    let h = `<div class="chart-tooltip-title">Run ${tm.dataPoints?.[0]?.label || ''}</div>`;
